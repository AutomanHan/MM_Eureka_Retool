...
model_tag=qwen_7b_single_node_mm_eureka_1
OUTPUT_DIR='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hldy-nlp/VLIT/hancong11/models/megatron/hl_output_reasoning/model_tag'
