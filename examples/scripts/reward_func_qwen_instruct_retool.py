        ...
        for query, prompt, answer in zip(queries, prompts, labels):
            try:
                ...
                if response == "":
                    ...
                    format_code_reward=format_code_func(response)
                    # import pdb;pdb.set_trace()
                    format_code_reward = format_code_reward if accuracy_reward>0.0 else 0.0

                    rewards.append(accuracy_reward + format_reward +format_code_reward)
                    ...
                    f.write(f"Accuracy Reward: {accuracy_reward}\tFormat Reward: {format_reward} \t Formatcode Reward: {format_code_reward} \n\n\n\n")
                    f.write(f"===============================================================\n")
            except:
                f.write("Error: " + query + "\n")
                rewards.append(0.0)
