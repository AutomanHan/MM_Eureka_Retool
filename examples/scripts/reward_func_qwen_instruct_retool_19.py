        ...
        for query, prompt, answer in zip(queries, prompts, labels):
            try:
                ...
                if response == "":
                    ...
                    # origal_reward_code, reward_code = 0.0, 0.0

                    # if accuracy_reward < 0.1:
                    #     reward_code = 0.0

                    reward_tmp = format_reward + accuracy_reward
