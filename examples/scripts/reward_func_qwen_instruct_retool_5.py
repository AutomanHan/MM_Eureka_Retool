...
def format_reward_func(completion, **kwargs):
    ...
    return 0.25 if matches else 0.0
        ...
        for query, prompt, answer in zip(queries, prompts, labels):
            try:
                ...
                if response == "":
                    ...
                    run_code_bonus = 0.25 if (accuracy_reward > 0.0 and run_code_acc > 0.0) else 0.0
                    ...
                    f.write(f"Accuracy Reward: {accuracy_reward}\tFormat Reward: {format_reward} \t Formatcode Reward: {format_code_reward} \t Runcode Bonus: {run_code_bonus} \n\n\n\n")
                    f.write(f"===============================================================\n")
            except:
                f.write("Error: " + query + "\n")
                rewards.append(0.0)
