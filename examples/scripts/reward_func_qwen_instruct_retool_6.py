        ...
        for query, prompt, answer in zip(queries, prompts, labels):
            try:
                ...
                if response == "":
                    ...
                    reward_tmp = format_reward + accuracy_reward #+ run_code_acc
                    ...
                    f.write(f"Accuracy Reward: {accuracy_reward}\tFormat Reward: {format_reward} \t run_code_times_total: {run_code_times_total} \t run_code_times_success: {run_code_times_success} \n\n\n\n")
                    f.write(f"===============================================================\n")
            except:
                f.write("Error: " + query + "\n")
                rewards.append(0.0)
