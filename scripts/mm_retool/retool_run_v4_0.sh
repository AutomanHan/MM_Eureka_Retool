...
# conda activate mm-r
model_tag=qwen25vl_7b_mm_retool_v4_0_onlycodereward
...
# examples/scripts/reward_func_qwen_instruct_retool_onlycode.py
...
RAY_ADDRESS="http://127.0.0.1:$RAY_DASHBOARD_PORT" ray job submit \
  ...
  --remote_rm_url examples/scripts/reward_func_qwen_instruct_retool_onlycode2.py \
  --actor_num_nodes 1 \
