...
# conda activate mm-r
model_tag=retool_run_0702_bs64_reward_v5_mixed_sft_k12_rl
MODEL_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv/lanxiaohan/qwenvl25_outputs/qwen25vl_retool_full_sft_mixed_code_4k_v3_zw_4x8_3e_bs64/full/sft/checkpoint-177/
...
RAY_ADDRESS="http://127.0.0.1:$RAY_DASHBOARD_PORT" ray job submit \
  ...
  -- python3 -m openrlhf.cli.train_ppo_ray \
    --remote_rm_url examples/scripts/reward_func_qwen_instruct_retool_5.py \
    --actor_num_nodes 1 \
