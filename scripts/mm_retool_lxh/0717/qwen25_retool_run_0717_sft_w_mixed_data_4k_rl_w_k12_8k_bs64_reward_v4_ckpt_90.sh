...
# conda activate mm-r
model_tag=qwen25_retool_run_0717_sft_w_mixed_data_4k_rl_w_k12_8k_bs64_reward_v4_ckpt_90
MODEL_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv/lanxiaohan/qwenvl25_outputs/qwen25vl_retool_full_sft_mixed_code_exec_4k_zw_4x8_3e_bs64/full/sft/checkpoint-90/
...
export RAY_MASTER_PORT=6387
export RAY_DASHBOARD_PORT=8279
