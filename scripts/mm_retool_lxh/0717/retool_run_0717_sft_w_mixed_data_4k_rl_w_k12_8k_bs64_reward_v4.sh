...
# conda activate mm-r
model_tag=retool_run_0717_sft_w_mixed_data_4k_rl_w_k12_8k_bs64_reward_v4
MODEL_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv/lanxiaohan/qwenvl25_outputs/qwen25vl_retool_full_sft_mixed_code_exec_4k_zw_4x8_3e_bs64/full/sft/checkpoint-168/
