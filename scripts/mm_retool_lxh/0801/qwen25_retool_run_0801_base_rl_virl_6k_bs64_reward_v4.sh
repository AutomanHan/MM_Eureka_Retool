...
# conda activate mm-r
model_tag=qwen25_retool_run_0801_base_rl_virl_6k_bs64_reward_v4
MODEL_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv-hl/hadoop-basecv/user/lanxiaohan/Qwen/Qwen2.5-VL-7B-Instruct
DATA_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv/lanxiaohan/reasoning_hc/data/Data_Mine/MM_ReTool/SFT_CoT_Data/0702/base_vl_38k_pr_required_codes.jsonl
