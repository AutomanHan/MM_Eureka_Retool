...
# conda activate mm-r
model_tag=qwen25_retool_run_0801_chartqa_60k_bs64_reward_ocr
MODEL_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv-hl/hadoop-basecv/user/lanxiaohan/Qwen/Qwen2.5-VL-7B-Instruct
DATA_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv/lanxiaohan/reasoning_hc/data/Data_Mine/MM_ReTool/SFT_CoT_Data/0801/chartqa_60k_retool_sys.jsonl
