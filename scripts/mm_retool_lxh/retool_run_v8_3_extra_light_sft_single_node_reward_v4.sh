...
# conda activate mm-r
model_tag=qwen25vl_7b_mm_retool_v8_3_codereward_extra_light_sft_reward_v4_single_node
MODEL_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv/lanxiaohan/qwenvl25_outputs/qwen25vl_retool_full_sft_mm_code_0.1k_v3_zw_4x8_1e_bs64/full/sft/checkpoint-2/
...
export RAY_DASHBOARD_PORT=8261
