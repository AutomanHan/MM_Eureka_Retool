...
# conda activate mm-r
model_tag=qwen25vl_7b_mm_retool_v8_3_codereward_light_sft_for_debug
MODEL_PATH=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-basecv/lanxiaohan/qwenvl25_outputs/qwen25vl_retool_full_sft_mm_code_1.8k_v3_zw_4x8_5e_bs64/full/sft/checkpoint-140/
